...
/**
 * @file   test_packet_types.c
 * @brief  Check that ROHC algorithm for packet decision is correct
...
{
	fprintf(stderr,
	        "Check that ROHC algorithm for packet decision is correct\n"
	        "\n"
	        "With the correct parameters, this tool may also check that the RTP\n"
	        "UO-1* / UOR-2* disambiguation algorithm is correct.\n"
	        "\n"
	        "usage: test_packet_types [OPTIONS] FLOW PACKET_TYPE\n"
	        "\n"
	        "with:\n"
                                ...
                                const rohc_packet_t expected_packet)
{
	...
	if(!are_packet_types_equal(pkt_type_comp, expected_packet))
	{
	...
	if(!are_packet_types_equal(pkt_type_decomp, expected_packet))
	{
