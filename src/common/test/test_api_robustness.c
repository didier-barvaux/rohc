/*
 * Copyright 2015,2016,2019 Didier Barvaux
 *
...
static void check_api_rohc_strerror(void);
static void check_api_rohc_get_mode_descr(void);
static void check_api_rohc_get_profile_descr(void);
static void check_api_rohc_profile_is_rohcv1(void);
static void check_api_rohc_profile_is_rohcv2(void);
static void check_api_rohc_profile_get_other_version(void);
static void check_api_rohc_get_packet_descr(void);
static void check_api_rohc_get_ext_descr(void);
static void check_api_rohc_get_packet_type(void);
static void check_fct_rohc_get_ip_proto_descr(void);
static void check_fct_rohc_ip_id_behavior_get_descr(void);
static void check_fct_tcp_opt_get_descr(void);
static void check_api_rohc_buf(void);


/** whether to run in verbose mode or not */
...
int main(int argc, char *argv[])
{
	...
	/* rohc_strerror() */
	check_api_rohc_strerror();

	/* rohc_get_mode_descr() */
	check_api_rohc_get_mode_descr();

	/* rohc_get_profile_descr() */
	check_api_rohc_get_profile_descr();

	/* rohc_profile_is_rohcv1() */
	check_api_rohc_profile_is_rohcv1();

	/* rohc_profile_is_rohcv2() */
	check_api_rohc_profile_is_rohcv2();

	/* rohc_profile_get_other_version() */
	check_api_rohc_profile_get_other_version();

	/* rohc_get_packet_descr() */
	check_api_rohc_get_packet_descr();

	/* rohc_get_ext_descr() */
	check_api_rohc_get_ext_descr();

	/* rohc_get_packet_type() */
	check_api_rohc_get_packet_type();

	/* not a public API, but best place to test: rohc_get_ip_proto_descr() */
	check_fct_rohc_get_ip_proto_descr();

	/* not a public API, but best place to test: rohc_ip_id_behavior_get_descr() */
	check_fct_rohc_ip_id_behavior_get_descr();

	/* not a public API, but best place to test: tcp_opt_get_descr() */
	check_fct_tcp_opt_get_descr();
...
/** Check the robustness of rohc_strerror() API */
static void check_api_rohc_strerror(void)
{
...
/** Check the robustness of rohc_get_mode_descr() API */
static void check_api_rohc_get_mode_descr(void)
{
	const char unknown[] = "no description";
...
/** Check the robustness of rohc_get_profile_descr() API */
static void check_api_rohc_get_profile_descr(void)
{
	const char unknown[] = "no description";
...
/** Check the robustness of rohc_profile_is_rohcv1() API */
static void check_api_rohc_profile_is_rohcv1(void)
{
...
/** Check the robustness of rohc_profile_is_rohcv2() API */
static void check_api_rohc_profile_is_rohcv2(void)
{
...
/** Check the robustness of rohc_profile_get_other_version() API */
static void check_api_rohc_profile_get_other_version(void)
{
...
/** Check the robustness of rohc_get_packet_descr() API */
static void check_api_rohc_get_packet_descr(void)
{
...
/** Check the robustness of rohc_get_ext_descr() API */
static void check_api_rohc_get_ext_descr(void)
{
...
/** Check the robustness of rohc_get_packet_type() API */
static void check_api_rohc_get_packet_type(void)
{
	...
	for(packet_type = ROHC_PACKET_IR; packet_type < ROHC_PACKET_MAX; packet_type++)
	{
...
/** Check the robustness of rohc_get_ip_proto_descr() function */
static void check_fct_rohc_get_ip_proto_descr(void)
{
...
/** Check the robustness of rohc_ip_id_behavior_get_descr() function */
static void check_fct_rohc_ip_id_behavior_get_descr(void)
{
...
/** Check the robustness of tcp_opt_get_descr() function */
static void check_fct_tcp_opt_get_descr(void)
{
...
/** Check the robustness of rohc_buf_*() APIs */
static void check_api_rohc_buf(void)
{
